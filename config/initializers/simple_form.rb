...
SimpleForm.setup do |config|
  ...
  config.wrappers :tailwind, tag: "div", class: "mb-4", error_class: :field_with_errors do |b|
    ...
    b.wrapper tag: "div", class: "relative" do |ba|
      ba.use :input, class: "w-full px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-purple-500 focus:border-transparent"
