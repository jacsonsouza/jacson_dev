...
export default class extends Controller {
  static targets = ["overlay", "menuToggle", "mobileMenu", "mobileMenuItem", "toggleIcon"];
  ...
  toggleMobileMenu() {
      ...
      if (this.isMenuOpen) {
          ...
          setTimeout(() => {
              this.mobileMenuTarget.classList.remove('opacity-0', 'translate-y-5');
  ...
  touchEnd(event) {
      ...
      // Se o usuário arrastou da borda esquerda (mais de 50px)
